...
UpgradeAdapter = /** @class */ (function () {
     ...
     * beforeEach(() => {
     *   upgradeAdapterRef = upgradeAdapter.registerForNg1Tests(['userApp']);
     * });
     *
     ...
     * ```
     * const upgradeAdapter = new UpgradeAdapter(MyNg2Module);
     * upgradeAdapter.declareNg1Module(['userApp']);
     * ```
     */
    /**
       * Declare the AngularJS upgrade module for this adapter without bootstrapping the whole
...
UpgradeAdapterRef = /** @class */ (function () {
    ...
    /* @internal */
    /* @internal */
    UpgradeAdapterRef.prototype._bootstrapDone = /* @internal */
