...
*  Usage:
*    InMemoryWebApiModule.forRoot(InMemUserService, {delay: 600})
*
 ...
 *
 * import { InMemUserService, inMemConfig } from '../api/in-memory-user.service';
 * @NgModule({
 *  imports: [
 *    HttpModule,
 *    HttpClientInMemoryWebApiModule.forRoot(InMemUserService, inMemConfig),
 *    ...
 *  ],
 *  ...
 * })
